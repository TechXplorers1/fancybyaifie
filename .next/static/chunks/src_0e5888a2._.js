...
_s(ThemeProvider, "foNRJAbF3SLon9j3fXHQCVL1R1o=");
_c = ThemeProvider;
const useTheme = ()=>{
    _s1();
        ...
        "FirebaseErrorListener.useEffect": ()=>{
            const handleError = {
                "FirebaseErrorListener.useEffect.handleError": (error)=>{
                    ...
                    // This is a special hook for development to show Next.js error overlay
...
function FirebaseProvider({ children, value }) {
...
_s1(useFirebaseApp, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
const useAuth = ()=>{
    _s2();
...
_s3(useFirestore, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
const useDatabase = ()=>{
    _s4();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(FirebaseContext)?.db;
};
_s4(useDatabase, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
...
function useCollection(query, options = {}) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCollection.useEffect": ()=>{
            ...
            setLoading(true);
            if (once) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(query).then({
                    "useCollection.useEffect": (snapshot)=>{
                        const data = snapshot.docs.map({
                            "useCollection.useEffect.data": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["useCollection.useEffect.data"]);
                        setData(data);
                        setLoading(false);
                    }
                }["useCollection.useEffect"]).catch({
                    "useCollection.useEffect": async (serverError)=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(query, {
                "useCollection.useEffect.unsubscribe": (snapshot)=>{
                    const data = snapshot.docs.map({
                        "useCollection.useEffect.unsubscribe.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["useCollection.useEffect.unsubscribe.data"]);
                    setData(data);
                    setLoading(false);
                    setError(null);
                }
...
_s(useCollection, "Xwjc8UVJdF4JzIORMdjj5R8tQLE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function useDoc(ref, options = {}) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDoc.useEffect": ()=>{
            ...
            setLoading(true);
            if (once) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(ref).then({
                    "useDoc.useEffect": (snapshot)=>{
                        if (snapshot.exists()) {
                            setData({
                                id: snapshot.id,
                                ...snapshot.data()
                ...
                }["useDoc.useEffect"]).catch({
                    "useDoc.useEffect": async (serverError)=>{
                        setError(serverError);
                        setLoading(false);
                        const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                            path: ref.path,
...
_s(useDoc, "Xwjc8UVJdF4JzIORMdjj5R8tQLE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/firebase/use-memo-firebase.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$use$2d$memo$2d$firebase$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/use-memo-firebase.tsx [app-client] (ecmascript)");
'use client';
;
;
;
...
function initializeFirebase(config) {
    const app = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApps"])().length === 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initializeApp"])(config) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])();
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$35c79a8a$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__p__as__getAuth$3e$__["getAuth"])(app);
    const firestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirestore"])(app);
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(app);
    // NOTE: This is a placeholder for the emulator URLs.
    // In a real-world scenario, you would use environment variables.
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_USE_FIREBASE_EMULATOR === 'true' && global.emulatorConnected !== true) {
        console.log('Using Firebase Emulators');
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$35c79a8a$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__L__as__connectAuthEmulator$3e$__["connectAuthEmulator"])(auth, 'http://127.0.0.1:9099', {
                disableWarnings: true
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["connectFirestoreEmulator"])(firestore, '127.0.0.1', 8080);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["connectDatabaseEmulator"])(db, '127.0.0.1', 9000);
            global.emulatorConnected = true;
        } catch (e) {
...
const { app, auth, firestore, db } = initializeFirebase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firebaseConfig"]);
;
;
;
;
...
function FirebaseClientProvider({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirebaseProvider"], {
        value: {
            ...
            db: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"]
        },
        children: children
    }, void 0, false, {
...
//# sourceMappingURL=src_0e5888a2._.js.map