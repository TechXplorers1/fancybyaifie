      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>
              Your privacy is important to me. This Privacy Policy explains how Fancy
              by Aifie (“we,” “I,” or “the site”) collects, uses, and protects your
              personal information when you visit or interact with this website.
            </p>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2">
              ...
              <li>
                Website usage data, including pages viewed, time spent on site, and
                general traffic analytics
              </li>
            </ul>

            <p>
              This information helps improve the website, create better content, and
            ...
            <p>
              This website may include links to third-party websites or affiliate
              partners. These external sites have their own privacy policies, and Fancy
              by Aifie is not responsible for their practices or content.
            </p>

            <h2>Cookies</h2>

            <p>
              Cookies help personalize your experience and track website performance.
            ...
            <p>
              By using this website, you consent to the terms outlined in this Privacy
              Policy.
            </p>
