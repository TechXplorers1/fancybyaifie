    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl w-full h-full sm:h-[90vh] p-0 flex flex-col sm:rounded-lg">
        <ScrollArea className="flex-1">
          {post.image && (
            <div className="relative w-full aspect-video sm:aspect-[2/1] bg-muted">
              <Image
          ...
          <DialogHeader className="p-6 sm:p-8 text-left">
            <DialogTitle className="text-2xl sm:text-4xl font-headline text-primary leading-tight">
              {post.title}
            </DialogTitle>
          </DialogHeader>
          <div
            className="prose dark:prose-invert prose-lg max-w-none px-6 sm:px-8 pb-10"
